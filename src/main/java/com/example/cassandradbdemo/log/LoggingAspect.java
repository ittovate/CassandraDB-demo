package com.example.cassandradbdemo.log;
...
import static com.example.cassandradbdemo.constant.AspectConstant.*;
import static com.example.cassandradbdemo.util.AspectUtil.*;
...
public class LoggingAspect {
     ...
     */
    @Around("execution(* com.example.cassandradbdemo.*.*.*(..))")
